                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" min="0" id="pase_2dias" size="3" name="boletos[dos_dias][cantidad]" placeholder="0">
                ...
                <div class="caja">
                    ...
                    <div id="viernes" class="contenido-dia clearfix">
                        ...
                        <div>
                            ...
                            <label><input type="checkbox" name="registro[]" id="taller_03" value="taller_03"><time>14:00</time> HTML5 y CSS</label>
                    ...
                    <div id="sabado" class="contenido-dia clearfix">
                        ...
                        <div>
                            <p>Conferencias</p>
                            <label><input type="checkbox" name="registro[]" id="conf_04" value="conf_04"><time>10:00</time> Como crear una Tienda Online</label>
                    ...
                    <div id="domingo" class="contenido-dia clearfix">
                        ...
                        <div>
                            <p>Seminarios</p>
                            <label><input type="checkbox" name="registro[]" id="sem_04" value="sem_02"><time>10:00</time> Crea una App en Android en una tarde</label>
                            <label><input type="checkbox" name="registro[]" id="sem_05" value="sem_03"><time>17:00</time> Crea una App en IOS en una tarde</label>
                        </div>
                    </div>
                    <!--Domingo-->
                </div>
